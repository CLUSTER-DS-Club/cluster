  ...
  return (
    <div className="disclaimer-container">
      ...
      <p className="disclaimer-text">
        ...
        regarding the accuracy, adequacy, validity, or completeness of any
        information.
      </p>

      <h2 className="disclaimer-subtitle">No Professional Advice</h2>
      <p className="disclaimer-text">
        The content on this site does not constitute professional advice (legal,
        medical, financial, etc.). You should consult the appropriate
        professionals before acting on any information provided.
      </p>

      <h2 className="disclaimer-subtitle">Limitation of Liability</h2>
      <p className="disclaimer-text">
        Under no circumstance shall the CLUSTER team be held liable for any loss
        or damage incurred as a result of using the site or relying on the
        information provided.
      </p>

      <h2 className="disclaimer-subtitle">External Links Disclaimer</h2>
      <p className="disclaimer-text">
        This site may contain links to external websites. We do not guarantee
        the accuracy, relevance, or safety of any external content and are not
        responsible for it.
      </p>

      <h2 className="disclaimer-subtitle">Changes to This Disclaimer</h2>
      <p className="disclaimer-text">
        We may update this disclaimer at any time without notice. You are
